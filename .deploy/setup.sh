...
for dom in www.caninecapitalfund.com investor.caninecapitalfund.com portal.caninecapitalfund.com borrowers.caninecapitalfund.com admin.caninecapitalfund.com; do
...
echo "---- DONE: www + investor + portal + borrowers + admin now auto-deploy within ~2 min ----"
